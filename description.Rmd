...
The National Basketball Association (NBA) is a professional basketball league in North America that draws the attention of many basketball fans all over the world. As NBA fans ourselves, we thought it would be interesting to predict the NBA playoff teams for this season. The target audience are NBA fans all over the world. 
