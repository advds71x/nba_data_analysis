...
```{r,warning=F,message=F}
#To identify if there is a cutoff for being considered a playoff contender, 
#we can plot the distribution of the W/L% of playoff teams and color the distribution 
